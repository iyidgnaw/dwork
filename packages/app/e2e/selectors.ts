...
export const sessionTaskDockSelector = '[data-component="session-task-dock"]'
export const toastSelector = '[data-component="toast"]'
export const toastTitleSelector = '[data-slot="toast-title"]'
export const toastDescriptionSelector = '[data-slot="toast-description"]'
